...
export const PricingView = ({ navigateTo }) => {
  ...
  return (
    <div className="w-full relative pt-32 px-6 max-w-6xl mx-auto pb-32">
      ...
      >
        ...
        {/* Growth (Highlighted) */}
        <motion.article variants={fadeUpBlurVariant} className="glass-card p-10 flex flex-col border-[#3a28a5]/50 relative transform md:-translate-y-4 klein-glow bg-[#0a061c]/90">
          <div aria-hidden="true" className="absolute top-0 left-0 w-full h-[3px] bg-gradient-to-r from-[#3a28a5] to-[#8773ff] rounded-t-[24px]"></div>
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#3a28a5] text-[#e5e6e6] px-5 py-1.5 rounded-full font-body text-[10px] font-bold uppercase tracking-[0.2em] shadow-[0_0_15px_rgba(58,40,165,0.5)] whitespace-nowrap">Most Popular</div>
