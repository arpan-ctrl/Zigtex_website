...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#020108] text-[#e5e6e6] font-body selection:bg-[#8773ff]/30 flex flex-col relative w-full">
      ...
      <main id="main-content" className="relative z-10 flex-grow font-body">
        ...
        {currentPage === 'use-cases' && <UseCasesView navigateTo={navigateTo} />}
      ...
      {/* GLOBAL FOOTER */}
      <footer role="contentinfo" className="border-t border-[#8773ff]/20 bg-[#020108] pt-32 pb-12 px-6 md:px-12 relative z-10 mt-auto overflow-hidden">
        <div aria-hidden="true" className="absolute top-0 left-1/2 -translate-x-1/2 w-[120%] max-w-5xl h-[500px] bg-[radial-gradient(ellipse_at_top,rgba(135,115,255,0.12),transparent_70%)] pointer-events-none" />
        <motion.div 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "-50px" }}
          variants={staggerContainerVariant}
          className="max-w-7xl mx-auto flex flex-col mb-16 relative z-10"
        >
          {/* Primary Heading */}
          <motion.h2 
            variants={fadeUpBlurVariant} 
            className="text-[#e5e6e6] tracking-wide uppercase leading-[0.95] mb-12"
            style={{ fontFamily: 'Arial, sans-serif', fontSize: '144px', fontWeight: 'bold' }}
          >
            Outbound,<br/>built to land.
          </motion.h2>

          {/* Primary Action (Email) */}
          <motion.div variants={fadeUpBlurVariant} className="mb-24">
            <a 
              href="mailto:info@zigtex.com" 
              className="font-body text-4xl md:text-5xl lg:text-6xl text-[#e5e6e6]/50 font-medium underline underline-offset-8 decoration-[#e5e6e6]/20 hover:decoration-[#e5e6e6]/50 hover:text-[#e5e6e6]/80 transition-all duration-300 inline-block focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#e5e6e6]/50 rounded-sm"
            >
              info@zigtex.com
            </a>
          </motion.div>
          ...
          {/* Footer Navigation */}
          <motion.div variants={fadeUpBlurVariant} className="flex flex-wrap items-center gap-x-12 gap-y-6">
            <button onClick={() => navigateTo('product')} className="font-body text-base font-medium text-[#e5e6e6]/80 hover:text-[#8773ff] transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#8773ff] rounded">Product</button>
            <button onClick={() => navigateTo('pricing')} className="font-body text-base font-medium text-[#e5e6e6]/80 hover:text-[#8773ff] transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#8773ff] rounded">Pricing</button>
            <button onClick={() => navigateTo('use-cases')} className="font-body text-base font-medium text-[#e5e6e6]/80 hover:text-[#8773ff] transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#8773ff] rounded">Solutions</button>
            <button onClick={() => navigateTo('resources')} className="font-body text-base font-medium text-[#e5e6e6]/80 hover:text-[#8773ff] transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#8773ff] rounded">Resources</button>
            <button onClick={() => navigateTo('company')} className="font-body text-base font-medium text-[#e5e6e6]/80 hover:text-[#8773ff] transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#8773ff] rounded">Company</button>
            <button className="font-body text-base font-medium text-[#e5e6e6]/80 hover:text-[#8773ff] transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#8773ff] rounded">Contact</button>
          </motion.div>

        </motion.div>
        
        {/* Bottom Bar */}
        <div className="max-w-7xl mx-auto pt-8 border-t border-[#8773ff]/20 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 font-body text-[12px] uppercase tracking-[0.2em] text-[#e5e6e6]/50 relative z-10">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-6">
            <span>© 2026 Zigtex</span>
            <span className="hidden md:inline text-[#e5e6e6]/20">|</span>
            <span>Outbound infrastructure platform</span>
          </div>
          <div className="flex flex-wrap gap-8">
            <button className="hover:text-[#8773ff] transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#8773ff] rounded">Privacy Policy</button>
            <button className="hover:text-[#8773ff] transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#8773ff] rounded">Terms of Service</button>
          </div>
        </div>
      </footer>
    </div>
